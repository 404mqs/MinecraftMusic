...
{
    public class Music : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, string[] command)
        {
            ...
            {
              UnturnedChat.Say(username, "Your Minecraft Music is already turned off.");
              return;
            }
            ...
            { 
                    ...
                    UnturnedChat.Say(username, "The MC Music was desactivated. Rejoin the server to re-activate it.");
            }
        }
    }
}
